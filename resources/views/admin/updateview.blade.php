          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item  d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="">+ Create New House</a>
              </li>
       ...
       <form action="{{url('/update',$data->id)}}" method="POST"  enctype="multipart/form-data">
        ...
        <div>
          ...
          <div>
           ...
           <input style="color:blue;" type="" name="categorie" value="{{$data->categorie}}" required>
        </div>
         <div>
           <label>Adress</label>
           <input style="color:blue;" type="text" name="adress" value="{{$data->adresse}}" required>
        </div>
         <div>
           <label>Surface</label>
           <input style="color:blue;" type="text" name="surface" value="{{$data->surface}}" required>
        </div>
         <div>
           <label>Prix</label>
           <input  style="color:blue;" type="text" name="prix" value="{{$data->prix}}" required>
        </div>
        <div>
        ...
        <div>
          <input style="color:" type="submit" value="Save">
        </div>
